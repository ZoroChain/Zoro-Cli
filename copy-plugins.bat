...
xcopy ..\Zoro-Plugins\SimplePolicy\bin\Release\netstandard2.0\SimplePolicy.dll zoro-cli\bin\Release\netcoreapp2.1\Plugins\ /y /q
xcopy ..\Zoro-Plugins\SimplePolicy\SimplePolicy zoro-cli\bin\Release\netcoreapp2.1\Plugins\SimplePolicy\ /y /q

xcopy ..\Zoro-Plugins\ApplicationLogs\bin\Release\netstandard2.0\ApplicationLogs.dll zoro-cli\bin\Release\netcoreapp2.1\Plugins\ /y /q
xcopy ..\Zoro-Plugins\ApplicationLogs\ApplicationLogs zoro-cli\bin\Release\netcoreapp2.1\Plugins\ApplicationLogs\ /y /q
