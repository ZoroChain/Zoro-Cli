...
namespace Zoro.Shell
{
    ...
    public class Coins
    {
        ...
        public Coins(Wallet wallet, ZoroSystem system)
        {
        ...
        {
            using (Snapshot snapshot = Blockchain.Root.GetSnapshot())
            {
        ...
        private Transaction SignTransaction(Transaction tx)
        {
            ...
            try
            {
                context = new ContractParametersContext(tx, Blockchain.Root);
            }
